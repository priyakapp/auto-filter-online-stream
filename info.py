...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001656843259')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001973361665')
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'v9VjqhQCiUWzX3k948To2FMYHJg2')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "7")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/The_Anime_Society')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Anime_Unloaded')
TUTORIAL = environ.get('TUTORIAL', ' ')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', False))
MSG_ALRT = environ.get('MSG_ALRT', 'Love by @pro_morningstar❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001938354811'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'The_Anime_Society')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001938354811')).split()]
...
URL = "https://anime-desifjdj-1d455e2bf508.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://anime-desifjdj-1d455e2bf508.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://anime-desifjdj-1d455e2bf508.herokuapp.com/".format(FQDN)
else:
    URL = "https://anime-desifjdj-1d455e2bf508.herokuapp.com/".format(FQDN)
